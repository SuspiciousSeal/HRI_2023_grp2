...
#include "ta_sendmovecmd/temoto_action.h"
...
#include <thread>
/* 
 * ACTION IMPLEMENTATION of TaSendmovecmd 
 */
class TaSendmovecmd : public TemotoAction
{
public:
...
void initializeTemotoAction()
{
  ...
  TEMOTO_INFO_STREAM("Move cmd action initialized");
}
...
CLASS_LOADER_REGISTER_CLASS(TaSendmovecmd, ActionBase);
