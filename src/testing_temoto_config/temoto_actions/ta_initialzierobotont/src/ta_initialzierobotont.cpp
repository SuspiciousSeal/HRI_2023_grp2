...
#include "ta_initialzierobotont/temoto_action.h"
#include "temoto_robot_manager/robot_manager_interface.h"

/* 
 * ACTION IMPLEMENTATION of TaInitialzierobotont 
 */
class TaInitialzierobotont : public TemotoAction
{
public:
...
void setOutputParameters()
{
  ...
  SET_PARAMETER("robot_desctiption", "string", out_param_robot_description);
}
...
}; // TaInitialzierobotont class

/* REQUIRED BY CLASS LOADER */
CLASS_LOADER_REGISTER_CLASS(TaInitialzierobotont, ActionBase);
